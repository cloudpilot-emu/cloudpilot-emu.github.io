...
var ASM_CONSTS = {
  48730: ($0) => { wasmTable.grow(0x10000); for (let i = 0; i <= 0xffff; i++) wasmTable.set(wasmTable.length - 0xffff - 1 + i, wasmTable.get(HEAPU32[($0 >>> 2) + i])); return wasmTable.length - 0xffff - 1; }
};
...
var wasmImports = {
  /** @export */
  __emscripten_abort: __emscripten_abort,
  /** @export */
...
var ___start_em_js = Module['___start_em_js'] = 48680;
var ___stop_em_js = Module['___stop_em_js'] = 48730;
